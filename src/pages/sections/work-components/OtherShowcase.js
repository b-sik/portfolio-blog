        ...
        <ListGroup>
            ...
            <Container>
              <Row>
                <Col xs={8}>
                  ...
                  ADHD-inspired Twitter bot powered by AWS Lambda functions and
                  written with Python.
                </Col>
                <Col
                  xs={4}
            ...
            <Container>
              <Row>
                <Col xs={8}>
                  ...
                  via Composer package to prepare a zip archive for a WordPress
                  plugin.
                </Col>
                <Col
                  xs={4}
          ...
          <ListGroup.Item variant="info">
            <Container>
              <Row>
                <Col xs={8}>
                  &rarr;&nbsp;<strong>This Website</strong> | Fully static site
                  made with Gatsby, React, and Bootstrap.
                </Col>
                <Col
                  xs={4}
                  className="d-flex flex-column align-items-center justify-content-center"
